...
public class Medio extends javax.swing.JFrame {
    ...
    private void iniciarProgressBar() {
        Timer timer = new Timer(230, (ActionEvent e) -> {
            time.setValue(time.getValue() + 1);
            time.setBackground(Color.BLUE);
            time.setStringPainted(false);
    ...
    private void initComponents() {
        ...
        time = new progressbar.ProgressBarCustom();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(time, javax.swing.GroupLayout.DEFAULT_SIZE, 581, Short.MAX_VALUE)
        );
